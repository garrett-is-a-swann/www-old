...
@Component({
    selector: 'git-calendar',
    templateUrl: './git-calendar.component.html',
    styleUrls: ['./git-calendar.component.css']
})
export class GitCalendarComponent implements OnInit {
    ...
    ngOnInit() {
        var proxy = 'https://urlreq.appspot.com/req?method=GET&url=',
            url = proxy + 'https://github.com/garrett-is-a-swann',
            colors = {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch(url)
                ...
                .then(function fetchThen (body) {
                    ...
                    var months = [].slice.call(graph.querySelectorAll('.month'))
